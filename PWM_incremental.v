...
// Generated on: Mar  4 2025 16:12:12 IST (Mar  4 2025 10:42:12 UTC)
...
module PWM(clkin_pad, reset_pad, duty_cycle_pad, out_pad);
  ...
  ora311d1 g714__4319(.A (n_28), .B (n_19), .C1 (duty_cycle[5]), .C2
       (n_13), .C3 (n_8), .Z (n_29));
  ...
  aoi21d1 g718__6783(.A (n_24), .B1 (duty_cycle[4]), .B2 (n_3), .ZN
       (n_25));
  cg01d1 g720__3680(.A (n_21), .B (n_2), .CI (duty_cycle[3]), .CO
       (n_24));
  aoi21d1 g721__1617(.A (n_22), .B1 (n_18), .B2 (n_2), .ZN (n_23));
  cg01d1 g723__2802(.A (n_20), .B (n_6), .CI (duty_cycle[2]), .CO
       (n_21));
